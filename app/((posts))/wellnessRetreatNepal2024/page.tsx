...
<article id="2198578c-c14b-418c-be56-72187798872a" className="page sans">
  ...
  <div className="page-body">
    ...
    By the looks of it, it’ll take a couple of minutes to read. Share it, use it however you want. It’s a one-sided message; I am not looking to hear from anyone.
    </p>
    <p id="735099f2-a4c2-48f8-a776-fbf3f9284e55" className="">
    I am Shriyans Kapoor, a student for life, and professionally, I have been a software engineer and graduated from a silly college. I don’t work for Dr. Sharon and wasn’t directly a part of this wellness retreat of Exprimir101 Clinic. But I’d still like to say a couple of things that I have personally felt. Professionally, I have interest in building things and making them efficient. Design, however, has never been my forte, and being a minimalist doesn’t help either.
    </p>
    ...
    <p id="a3763171-3eb9-418f-ac85-36f7cd3aa9a5" className=""></p>
    ...
    <p id="d45c92cc-a197-42fa-b72c-0c4894e35984" className=""></p>
    ...
    <p id="e5e46074-a991-4ab7-b015-7e09f88b9644" className=""></p>
    ...
    <p id="df82c494-326e-48f0-b098-e5db131ad671" className=""></p>
    ...
    <p id="db6f0184-1820-46cb-9b87-25c894d451af" className=""></p>
    <p id="0972dab9-b730-49fb-8d64-f09cf779ba1c" className="">
      ...
      was I def don’t deserve to be a parent unless I match “her” energy,
      responsibility, and her pretty face. Trying to catch up with your
      pace on the trek was fun, and I loved the “non-taxing, non-small, not
      ...
      sincerity in you, but a calm exterior. I will try to be sturdier. I
      learned to be as strong as F from you. You are strength for me.
    </p>
    <p id="750a3f0a-688c-40f5-a3a6-072eadcf84e6" className=""></p>
    ...
    <p id="0a4ed07c-5c9f-4460-a0b6-daf110f5f6c5" className=""></p>
    <p id="8f7acc43-ad48-4df0-88b7-1a1c4b53bff0" className="">
      ...
      works at this place are amazing. I know how it could get tough sometimes,
      but you push each other to be a better self. Remember, The only way out
      is through.
    </p>
    <p id="5bf1275f-874e-4b71-b913-5e2cb1434c5c" className=""></p>
    ...
    <p id="2c20a764-68c0-4c17-b21f-4479dff92534" className=""></p>
    ...
    <p id="8f353ce4-971a-42f5-8139-39d768bc7082" className=""></p>
    ...
    <p id="cb74cfc0-939a-42ae-bc08-b4ad2196e0fa" className=""></p>
    ...
    <p id="d533e604-44be-4efa-8a5e-96912bd515e5" className="">
      ...
      team— and I shall transfer the details (1 min task). For the next 365 days, I have
      subscribed for this.
